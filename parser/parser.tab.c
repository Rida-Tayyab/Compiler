...
static const yytype_int8 yyrline[] =
{
      ...
      57,    61,    62,    63,    67,    78,    79,    80,    84,    85,
      93,    97,    98,   102,   103,   104,   105,   111
};
#endif
...
static const char *const yytname[] =
{
  ...
  "IF", "THEN", "ELSE", "WHILE", "FOR", "DO", "RETURN", "BREAK",
  "CONTINUE", "INT", "FLOAT", "DOUBLE", "CHAR", "VOID", "BEGIN_KW", "END",
  "PROCEDURE", "FUNCTION", "PLUS", "MINUS", "MULT", "DIV", "POW", "ASSIGN",
  "EQ", "NE", "LT", "LE", "GT", "GE", "AND", "OR", "NOT", "LPAREN",
  "RPAREN", "LBRACE", "RBRACE", "SEMICOLON", "COMMA", "UMINUS", "$accept",
  "program", "statement_list", "statement", "declaration", "assignment",
  "expr", "term", "factor", "base", YY_NULLPTR
};
...
{
       0,   -35,   -36,   -36,    -3,    25,    28,    41,    48,    48,
      39,    57,     6,   -36,    16,    24,   -11,    34,   -36,    40,
     -36,    48,   -36,   -36,   -36,   -36,   -36,    -5,    33,   -36,
     -36,   -36,   -36,    48,    48,   -36,    48,    48,    48,    38,
     -36,   -36,    34,    34,   -36,   -36,   -36
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     0,     4,     0,     0,     0,    17,    20,    22,
      10,     0,    11,    12,    13,    26,    27,     0,     0,     1,
       5,     7,     8,     0,     0,     6,     0,     0,     0,    14,
      23,     9,    15,    16,    18,    19,    21
};
...
{
      -2,     1,    30,     2,     3,     4,    -3,     1,    20,     2,
       3,     4,    27,    33,    34,     5,     6,     7,    30,    33,
      34,     5,     6,     7,    39,     8,    21,    44,    45,    46,
      22,     8,    35,    23,     1,    40,     2,     3,     4,     9,
       1,    10,     2,     3,     4,     9,    24,    10,     5,     6,
       7,     2,     3,    25,     5,     6,     7,    29,     8,    31,
      36,    37,    33,    34,     8,    42,    43,    32,    38,    28,
      26,     0,     9,     8,    10,    41,     0,     0,     9,     0,
      10,     0,     0,     0,     0,     0,     0,     9
};

static const yytype_int8 yycheck[] =
{
       0,     1,    12,     3,     4,     5,     0,     1,    43,     3,
       4,     5,     9,    24,    25,    15,    16,    17,    28,    24,
      25,    15,    16,    17,    21,    25,    29,    36,    37,    38,
       5,    25,    43,     5,     1,    40,     3,     4,     5,    39,
       1,    41,     3,     4,     5,    39,     5,    41,    15,    16,
      17,     3,     4,     5,    15,    16,    17,     0,    25,    43,
      26,    27,    24,    25,    25,    33,    34,    43,    28,    10,
       8,    -1,    39,    25,    41,    42,    -1,    -1,    39,    -1,
      41,    -1,    -1,    -1,    -1,    -1,    -1,    39
};
...
{
       0,     1,     3,     4,     5,    15,    16,    17,    25,    39,
      41,    47,    48,    49,    50,    51,    52,    53,    54,    55,
      43,    29,     5,     5,     5,     5,    55,    52,    48,     0,
      49,    43,    43,    24,    25,    43,    26,    27,    28,    52,
      40,    42,    53,    53,    54,    54,    54
};
...
#line 1161 "parser/parser.tab.c"
  ...
  case 10: /* statement: error SEMICOLON  */
...
#line 1234 "parser/parser.tab.c"
  ...
  case 21: /* factor: base POW factor  */
...
#line 1246 "parser/parser.tab.c"
  ...
  case 23: /* base: LPAREN expr RPAREN  */
...
#line 105 "parser/parser.y"
        ...
        (yyval.fval) = 0;  /* Placeholder */
        free((yyvsp[0].sval));
    }
#line 1275 "parser/parser.tab.c"
    break;

  case 27: /* base: MINUS base  */
